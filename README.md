...
|Task|Our Submission|
|-------|-------------|
| Document your sprint forecast and rationale in README | Our first sprint has three stories totalling 10 points. These stories were selected based on how they will satisfy the preconditions of getting our infrastructure set up and getting a user logged in. As our first sprint we don't have any prior evidence for how many points we can do in a sprint, so we came to a conservative consensus at 10. The rationale is to prioritize the items most valuable to the stakeholder. Our main stakeholder, the radiologist wants the mammogram analyzed accurately hence, image analysis is high priority and first on our product backlog. This is followed by the feature to upload the image into the system so that the radiologist can start the patient journey. The last user story covered in our SPRINT 1 is Accuracy Score - which is also high priority for the radiologist as they would like to be able to gauge the accuracy of the results obtained from the analysis. |
